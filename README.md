...
A tool to optimize gear for a character of the Project: Gorgon MMORPG. You can download the latest version (for client 461) [here](https://github.com/dlebansais/PgBuilder-Disclosed/releases/download/v2.0.461.1161/PgBuilder-Full.exe).
