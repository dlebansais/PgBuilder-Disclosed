...
A tool to optimize gear for a character of the Project: Gorgon MMORPG. You can download the latest version (for client 469) [here](https://github.com/dlebansais/PgBuilder-Disclosed/releases/download/v2.2.469.1166/PgBuilder-Full.exe).
